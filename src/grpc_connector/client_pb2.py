...
_POP = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='auth', full_name='PoP.auth', index=2,
      number=3, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_VDU = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='key', full_name='VDU.key', index=7,
...
_INSTALLMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='InstallMessage.metadata', index=4,
...
_POP.fields_by_name['auth'].message_type = _METADATAENTRY
_VDU.fields_by_name['metadata'].message_type = _METADATAENTRY
_VDU.fields_by_name['key'].message_type = _KEY
...
_INSTALLMESSAGE.fields_by_name['metadata'].message_type = _METADATAENTRY
