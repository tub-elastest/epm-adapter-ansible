...
_RESOURCEGROUPPROTO = _descriptor.Descriptor(
  ...
  nested_types=[_RESOURCEGROUPPROTO_METADATAENTRY, _RESOURCEGROUPPROTO_NETWORK, _RESOURCEGROUPPROTO_VDU, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
