...
_RESOURCEIDENTIFIER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='auth', full_name='ResourceIdentifier.auth', index=1,
...
_RESOURCEIDENTIFIER.fields_by_name['auth'].message_type = _AUTH
