    ...
    return dict( name="create",
        ...
        tasks=[
            dict(os_server=dict(state='present', auth=dict(auth_url=os_auth_url, username=os_username,
                                       ...
                                       name="vm1", timeout="200", image="ubuntu-14.04-server-cloudimg-amd64-disk1", key_name="rvl", flavor="m1.small",
                                security_groups="default", auto_ip="yes", network="private", wait='yes'), register='shell_out')
        ])
