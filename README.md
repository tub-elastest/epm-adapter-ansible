...
[![Build Status](https://ci.elastest.io/jenkins/buildStatus/icon?job=elastest-platform-manager/epm-adapter-ansible)](https://ci.elastest.io/jenkins/job/elastest-platform-manager/job/epm-adapter-ansible)
[![Quality Gate](https://sonarcloud.io/api/badges/gate?key=io.elastest:epm-adapter-ansible)](https://sonarcloud.io/dashboard/index/io.elastest:epm-adapter-ansible)
[![codecov](https://codecov.io/gh/elastest/elastest-platform-manager-adapter-ansible/branch/master/graph/badge.svg)](https://codecov.io/gh/elastest/elastest-platform-manager-adapter-ansible)
...
This repository contains an adapter to be used by the ElasTest Platform Manager to support ansible as a virtualization technology. Further documentation can be found [here](https://github.com/tub-elastest/epm-adapter-ansible/blob/master/docs/index.md).
