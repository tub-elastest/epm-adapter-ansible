...
This repository contains an adapter to be used by the ElasTest Platform Manager to support ansible as a virtualization technology. Further documentation can be found [here](https://github.com/mpauls/epm-adapter-ansible/blob/master/docs/index.md).
